...
// Sourced from React Bits' free/open-source Backgrounds collection
// (reactbits.dev/backgrounds/radar) — recolored for Grade Arena's brand
// via props only, component internals unchanged.
